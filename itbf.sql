...
CREATE TABLE public.habitaciones (
    ...
    CONSTRAINT habitaciones_tipo_habitacion_check CHECK (((tipo_habitacion)::text = ANY ((ARRAY['Estándar'::character varying, 'Junior'::character varying, 'Suite'::character varying])::text[])))
);
...
COPY public.habitaciones (id, hotel_id, cantidad, tipo_habitacion, acomodacion, created_at, updated_at) FROM stdin;
\.
...
COPY public.hoteles (id, ciudad, nombre, nit, direccion, numero_habitaciones, created_at, updated_at) FROM stdin;
\.
...
40	2026_05_06_030143_create_personal_access_tokens_table	1
41	2026_05_06_031400_hoteles	1
42	2026_05_06_031427_habitaciones	1
\.
...
--
-- Name: hoteles hoteles_direccion_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hoteles
    ADD CONSTRAINT hoteles_direccion_unique UNIQUE (direccion);
...
ALTER TABLE ONLY public.habitaciones
    ADD CONSTRAINT habitaciones_hotel_id_foreign FOREIGN KEY (hotel_id) REFERENCES public.hoteles(id) ON UPDATE CASCADE ON DELETE CASCADE;
